...
<div class="collapse" style="padding: 0;">
  ...
  <div class="slick mobile-slick show-for-small-only">
    <div style="background: url('http://www.medicalmalpracticeattorneyinfo.com/wp-content/uploads/2017/01/mobile_slider1.jpg'); height: 100%;  background-position: center; background-repeat: no-repeat; background-size: cover; overflow: hidden; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover; ">
      <img style="display: none; height:100vh !important; width: 100%; overflow: scroll !important; -webkit-overflow-scrolling: touch !important;" alt="slick hidden" />
    </div>
    <div style="background: url('http://www.medicalmalpracticeattorneyinfo.com/wp-content/uploads/2017/01/mobile_slider2.jpg'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover; overflow: hidden; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;">
      <img style="display: none; height:100vh !important; width: 100%; overflow: scroll !important; -webkit-overflow-scrolling: touch !important;" alt="slick hidden" />
    </div>
    <div style="background: url('http://www.medicalmalpracticeattorneyinfo.com/wp-content/uploads/2017/01/mobile_slider3.jpg'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover; overflow: hidden; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;">
      <img style="display: none; height:100vh !important; width: 100%; overflow: scroll !important; -webkit-overflow-scrolling: touch !important;" alt="slick hidden" />
    </div>
    <div style="background: url('http://www.medicalmalpracticeattorneyinfo.com/wp-content/uploads/2017/01/mobile_slider4.jpg'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover; overflow: hidden; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;">
      <img style="display: none; height:100vh !important; width: 100%; overflow: scroll !important; -webkit-overflow-scrolling: touch !important;" alt="slick hidden" />
    </div>
  </div>
  <?php get_header(); ?>
 ...
 <section class="row no-max collapse" id='pillars' style="padding: 0; margin: 0; background: white; ">
   <div class="small-12 medium-12 large-4 columns">
     <div class="block text-center">
       <h3 style="background: url('http://www.medicalmalpracticeattorneyinfo.com/wp-content/uploads/2017/06/experience_.png'); background-size:cover;" >Experience<br><br><span class="smaller">Led by Charles Thronson, the Personal Injury practice group at Parsons Behle &amp; Latimer has more than thirty years of experience representing clients in complex medical malpractice cases.</span></h3>
     </div>
   </div>
   <div class="small-12 medium-12 large-4 columns">
     <div class="block text-center">
       <h3 style="background: url('http://www.medicalmalpracticeattorneyinfo.com/wp-content/uploads/2017/06/results_.png'); background-size:cover;">Results<br><br><span class="smaller">We represent victims of medical negligence and believe they deserve the best possible legal representation in Utah. Our track record includes achieving a number of multi-million dollar settlements for our clients.</span></h3>
     </div>
   </div>
   <div class="small-12 medium-12 large-4 columns">
     <div class="block text-center">
       <h3 style="background: url('http://www.medicalmalpracticeattorneyinfo.com/wp-content/uploads/2017/06/integrity_.png'); background-size:cover;" >Integrity<br><br><span class="smaller">Our clients face enormous financial and emotional hardships as a result of medical malpractice. Our team works hand-in-hand to understand our client's injuries and assess their economic impact.</span></h3>
     </div>
   </div>
 </section>
 <section>
